...
namespace R2WpBaziPlugin\vendor\Symfony\Contracts\HttpClient\Test;

use PHPUnit\Framework\TestCase;
use R2WpBaziPlugin\vendor\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface;
...
abstract class HttpClientTestCase extends TestCase {
	...
	public function testRelativeRedirects() {
		...
		$response = $client->request(
			'GET',
			'http://localhost:8057/302/relative',
			[
				'max_redirects' => 0,
			]
			);
	...
	public function testOnProgressCancel() {
		...
		$response = $client->request(
			'GET',
			'http://localhost:8057/timeout-body',
			[
	...
	public function testNotATimeout() {
		...
		$response = $client->request(
			'GET',
			'http://localhost:8057/timeout-header',
			[
				'timeout' => 0.9,
			]
			);
	...
	public function testTimeoutWithActiveConcurrentStream() {
		...
		$blockingResponse  = $client->request(
			'GET',
			'http://localhost:8077/timeout-body',
			[
				'timeout' => 0.25,
			]
			);
	...
	public function testMaxDuration() {
		...
		$response = $client->request(
			'GET',
			'http://localhost:8057/max-duration',
			[
				'max_duration' => 0.1,
			]
			);
