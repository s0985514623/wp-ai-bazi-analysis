...
use R2WpBaziPlugin\vendor\Symfony\Component\HttpClient\Chunk\LastChunk;
...
trait TransportResponseTrait {
	 ...
	 * @internal
	 */
	final public static function stream( iterable $responses, ?float $timeout = null ): \Generator {
		$runningResponses = [];
