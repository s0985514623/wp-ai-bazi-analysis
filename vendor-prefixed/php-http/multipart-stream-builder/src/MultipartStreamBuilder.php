...
namespace R2WpBaziPlugin\vendor\Http\Message\MultipartStream;
...
use R2WpBaziPlugin\vendor\Http\Discovery\StreamFactoryDiscovery;
...
class MultipartStreamBuilder
{
     ...
     *
     * @param string|resource|\R2WpBaziPlugin\vendor\Psr\Http\Message\StreamInterface $resource the filepath, resource or StreamInterface of the data
