...
use R2WpBaziPlugin\vendor\Http\Discovery\Exception\ClassInstantiationFailedException;
use R2WpBaziPlugin\vendor\Http\Discovery\Exception\DiscoveryFailedException;
use R2WpBaziPlugin\vendor\Http\Discovery\Exception\NoCandidateFoundException;
use R2WpBaziPlugin\vendor\Http\Discovery\Exception\StrategyUnavailableException;
use R2WpBaziPlugin\vendor\Http\Discovery\Strategy\DiscoveryStrategy;
