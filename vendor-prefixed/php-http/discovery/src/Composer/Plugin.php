...
namespace R2WpBaziPlugin\vendor\Http\Discovery\Composer;
...
class Plugin implements PluginInterface, EventSubscriberInterface {
	...
	private const INTERFACE_MAP = [
		...
		'psr/http-client-implementation' => [
			'R2WpBaziPlugin\vendor\Psr\Http\Client\ClientInterface',
		],
		'psr/http-factory-implementation' => [
			'R2WpBaziPlugin\vendor\Psr\Http\Message\RequestFactoryInterface',
			'R2WpBaziPlugin\vendor\Psr\Http\Message\ResponseFactoryInterface',
			'R2WpBaziPlugin\vendor\Psr\Http\Message\ServerRequestFactoryInterface',
			'R2WpBaziPlugin\vendor\Psr\Http\Message\StreamFactoryInterface',
			'R2WpBaziPlugin\vendor\Psr\Http\Message\UploadedFileFactoryInterface',
			'R2WpBaziPlugin\vendor\Psr\Http\Message\UriFactoryInterface',
		],
	];
