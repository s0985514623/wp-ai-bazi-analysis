...
use R2WpBaziPlugin\vendor\Http\Discovery\ClassDiscovery;
use R2WpBaziPlugin\vendor\Http\Discovery\Exception\NotFoundException;
...
use R2WpBaziPlugin\vendor\Nyholm\Psr7\Factory\HttplugFactory as NyholmHttplugFactory;
use R2WpBaziPlugin\vendor\Psr\Http\Client\ClientInterface as Psr18Client;
use R2WpBaziPlugin\vendor\Psr\Http\Message\RequestFactoryInterface as Psr17RequestFactory;
use Slim\Http\Request as SlimRequest;
use R2WpBaziPlugin\vendor\Symfony\Component\HttpClient\HttplugClient as SymfonyHttplug;
use R2WpBaziPlugin\vendor\Symfony\Component\HttpClient\Psr18Client as SymfonyPsr18;
	...
	private static $classes = [
		...
		HttpAsyncClient::class => [
			[
				...
				'condition' => [ SymfonyHttplug::class, Promise::class, [ self::class, 'isPsr17FactoryInstalled' ] ],
			],
			[
				'class'     => Guzzle7::class,
		...
		HttpClient::class => [
			[
				'class'     => SymfonyHttplug::class,
				'condition' => [ SymfonyHttplug::class, [ self::class, 'isPsr17FactoryInstalled' ], [ self::class, 'isSymfonyImplementingHttpClient' ] ],
			],
			[
				'class'     => Guzzle7::class,
				'condition' => Guzzle7::class,
