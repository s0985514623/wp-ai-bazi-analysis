...
namespace R2WpBaziPlugin\vendor\Nyholm\Psr7;

use R2WpBaziPlugin\vendor\Psr\Http\Message\MessageInterface;
...
trait MessageTrait {
	...
	final public function getHeaderLine( $header ): string {
	 ...
	 * @return static
	 */
	final public function withHeader( $header, $value ): MessageInterface {
	 ...
	 * @return static
	 */
	final public function withAddedHeader( $header, $value ): MessageInterface {
	 ...
	 * @return static
	 */
	final public function withoutHeader( $header ): MessageInterface {
		if (!\is_string($header)) {
			throw new \InvalidArgumentException('Header name must be an RFC 7230 compatible string');
		}
