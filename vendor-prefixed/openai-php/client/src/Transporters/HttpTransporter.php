...
namespace R2WpBaziPlugin\vendor\OpenAI\Transporters;

use Closure;
use GuzzleHttp\Exception\ClientException;
use JsonException;
use R2WpBaziPlugin\vendor\OpenAI\Contracts\TransporterContract;
use R2WpBaziPlugin\vendor\OpenAI\Enums\Transporter\ContentType;
...
final class HttpTransporter implements TransporterContract {
	...
	public function requestObject( Payload $payload ): Response {
		...
		$response = $this->sendRequest(fn (): \R2WpBaziPlugin\vendor\Psr\Http\Message\ResponseInterface => $this->client->sendRequest($request));
