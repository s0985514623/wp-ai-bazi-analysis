...
namespace R2WpBaziPlugin\vendor\OpenAI;

use Closure;
use Exception;
use GuzzleHttp\Client as GuzzleClient;
use R2WpBaziPlugin\vendor\Http\Discovery\Psr18ClientDiscovery;
use R2WpBaziPlugin\vendor\OpenAI\Transporters\HttpTransporter;
use R2WpBaziPlugin\vendor\OpenAI\ValueObjects\ApiKey;
use R2WpBaziPlugin\vendor\OpenAI\ValueObjects\Transporter\BaseUri;
use R2WpBaziPlugin\vendor\OpenAI\ValueObjects\Transporter\Headers;
use R2WpBaziPlugin\vendor\OpenAI\ValueObjects\Transporter\QueryParams;
...
use R2WpBaziPlugin\vendor\Symfony\Component\HttpClient\Psr18Client;
