...
final class CreateStreamedResponse implements ResponseContract {
	...
	public static function from( array $attributes ): self {
		$choices = array_map(
			fn ( array $result ): CreateStreamedResponseChoice => CreateStreamedResponseChoice::from(
			$result
		),
			$attributes['choices']
			);
	...
	public function toArray(): array {
		...
		if ($this->usage instanceof \R2WpBaziPlugin\vendor\OpenAI\Responses\Chat\CreateResponseUsage) {
