...
trait Fakeable {
	 ...
	 */
	final public static function fake( array $override = [], ?MetaInformation $meta = null ): static {
	...
	final public static function fakeResponseMetaInformation(): MetaInformation {
